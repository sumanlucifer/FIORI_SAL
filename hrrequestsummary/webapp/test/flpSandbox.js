		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "HR Requests Summary",
									"targetURL": "#comsalhrrequestsummary-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsalhrrequestsummary-display": {
								"semanticObject": "comsalhrrequestsummary",
								"action": "display",
								"description": "HR Requests Summary Application.",
								"title": "HR Requests Summary",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sal.hrrequestsummary",
									"url": sap.ui.require.toUrl("com/sal/hrrequestsummary")
								}
							}
						}
					}
