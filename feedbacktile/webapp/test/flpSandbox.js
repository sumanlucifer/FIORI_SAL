		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsalfeedbacktile-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsalfeedbacktile-display": {
								"semanticObject": "comsalfeedbacktile",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sal.feedbacktile",
									"url": sap.ui.require.toUrl("com/sal/feedbacktile")
								}
							}
						}
					}
