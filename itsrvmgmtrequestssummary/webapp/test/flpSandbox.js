		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "IT Service Management Summary App",
									"targetURL": "#comsalitsrvmgmtrequestssummary-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsalitsrvmgmtrequestssummary-display": {
								"semanticObject": "comsalitsrvmgmtrequestssummary",
								"action": "display",
								"description": "IT Service Management Summary Application.",
								"title": "IT Service Management Summary App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sal.itsrvmgmtrequestssummary",
									"url": sap.ui.require.toUrl("com/sal/itsrvmgmtrequestssummary")
								}
							}
						}
					}
