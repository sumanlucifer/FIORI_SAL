		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Feedback Form",
									"targetURL": "#comsaluserfeedbackform-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsaluserfeedbackform-display": {
								"semanticObject": "comsaluserfeedbackform",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sal.userfeedbackform",
									"url": sap.ui.require.toUrl("com/sal/userfeedbackform")
								}
							}
						}
					}
