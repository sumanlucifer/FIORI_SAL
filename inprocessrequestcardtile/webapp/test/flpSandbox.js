		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Inprocess Request Card Tile",
									"targetURL": "#comsalcardsinprocessrequestcardtile-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsalcardsinprocessrequestcardtile-display": {
								"semanticObject": "comsalcardsinprocessrequestcardtile",
								"action": "display",
								"description": "Inprocess Request Card Tile",
								"title": "Inprocess Request Card Tile",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sal.cards.inprocessrequestcardtile",
									"url": sap.ui.require.toUrl("com/sal/cards/inprocessrequestcardtile")
								}
							}
						}
					}
