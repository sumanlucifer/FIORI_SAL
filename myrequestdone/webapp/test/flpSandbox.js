		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My Request Done App",
									"targetURL": "#comsalmyrequestdonemyrequestdone-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsalmyrequestdonemyrequestdone-display": {
								"semanticObject": "comsalmyrequestdonemyrequestdone",
								"action": "display",
								"description": "My Request Done Application.",
								"title": "My Request Done App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sal.myrequestdone.myrequestdone",
									"url": sap.ui.require.toUrl("com/sal/myrequestdone/myrequestdone")
								}
							}
						}
					}
