		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Chatbot Summary Report Application",
									"targetURL": "#comsalreportchatbotsummaryreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsalreportchatbotsummaryreport-display": {
								"semanticObject": "comsalreportchatbotsummaryreport",
								"action": "display",
								"description": "Chatbot Summary Report Application",
								"title": "Chatbot Summary Report Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sal.report.chatbotsummaryreport",
									"url": sap.ui.require.toUrl("com/sal/report/chatbotsummaryreport")
								}
							}
						}
					}
