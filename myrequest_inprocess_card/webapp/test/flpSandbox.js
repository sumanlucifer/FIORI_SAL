		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsalinprocessmyrequestinprocesscard-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsalinprocessmyrequestinprocesscard-display": {
								"semanticObject": "comsalinprocessmyrequestinprocesscard",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sal.inprocess.myrequestinprocesscard",
									"url": sap.ui.require.toUrl("com/sal/inprocess/myrequestinprocesscard")
								}
							}
						}
					}
