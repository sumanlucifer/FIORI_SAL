		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsalsummarytileshrrequestssummarymanagertile-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsalsummarytileshrrequestssummarymanagertile-display": {
								"semanticObject": "comsalsummarytileshrrequestssummarymanagertile",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sal.summarytiles.hrrequestssummarymanagertile",
									"url": sap.ui.require.toUrl("com/sal/summarytiles/hrrequestssummarymanagertile")
								}
							}
						}
					}
