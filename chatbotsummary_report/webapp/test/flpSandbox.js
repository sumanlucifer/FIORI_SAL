		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Chatbot Summary Report",
									"targetURL": "#comsalchatbotsummaryreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsalchatbotsummaryreport-display": {
								"semanticObject": "comsalchatbotsummaryreport",
								"action": "display",
								"description": "Chatbot Summary Report",
								"title": "Chatbot Summary Report",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sal.chatbotsummaryreport",
									"url": sap.ui.require.toUrl("com/sal/chatbotsummaryreport")
								}
							}
						}
					}
