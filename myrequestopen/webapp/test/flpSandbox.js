		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My Request Open App",
									"targetURL": "#comsalmyrequestopenmyrequestopen-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsalmyrequestopenmyrequestopen-display": {
								"semanticObject": "comsalmyrequestopenmyrequestopen",
								"action": "display",
								"description": "My Request Open Application.",
								"title": "My Request Open App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sal.myrequestopen.myrequestopen",
									"url": sap.ui.require.toUrl("com/sal/myrequestopen/myrequestopen")
								}
							}
						}
					}
