		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SLA Compliance Report App ",
									"targetURL": "#comsalreportsslacompliancereport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsalreportsslacompliancereport-display": {
								"semanticObject": "comsalreportsslacompliancereport",
								"action": "display",
								"description": "SLA Compliance Report Application.",
								"title": "SLA Compliance Report App ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sal.reports.slacompliancereport",
									"url": sap.ui.require.toUrl("com/sal/reports/slacompliancereport")
								}
							}
						}
					}
