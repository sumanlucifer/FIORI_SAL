		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsalitsrvmgmtrequestssummarymanagertile-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsalitsrvmgmtrequestssummarymanagertile-display": {
								"semanticObject": "comsalitsrvmgmtrequestssummarymanagertile",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sal.itsrvmgmtrequestssummarymanagertile",
									"url": sap.ui.require.toUrl("com/sal/itsrvmgmtrequestssummarymanagertile")
								}
							}
						}
					}
