		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsalsalportalhr-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsalsalportalhr-display": {
								"semanticObject": "comsalsalportalhr",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sal.salportalhr",
									"url": sap.ui.require.toUrl("com/sal/salportalhr")
								}
							}
						}
					}
