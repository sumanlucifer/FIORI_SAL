		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsalitsrvmgmtrequestssummarymanager-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsalitsrvmgmtrequestssummarymanager-display": {
								"semanticObject": "comsalitsrvmgmtrequestssummarymanager",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sal.itsrvmgmtrequestssummarymanager",
									"url": sap.ui.require.toUrl("com/sal/itsrvmgmtrequestssummarymanager")
								}
							}
						}
					}
