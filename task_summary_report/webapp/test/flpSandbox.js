		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Task Summary Report Application",
									"targetURL": "#comsaltasksummaryreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsaltasksummaryreport-display": {
								"semanticObject": "comsaltasksummaryreport",
								"action": "display",
								"description": "Task Summary Report Application.",
								"title": "Task Summary Report Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sal.tasksummaryreport",
									"url": sap.ui.require.toUrl("com/sal/tasksummaryreport")
								}
							}
						}
					}
