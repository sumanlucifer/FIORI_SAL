		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsalfeedbackform-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsalfeedbackform-display": {
								"semanticObject": "comsalfeedbackform",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sal.feedbackform",
									"url": sap.ui.require.toUrl("com/sal/feedbackform")
								}
							}
						}
					}
