		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "User Creation",
									"targetURL": "#comsalsalhrcreateuser-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsalsalhrcreateuser-display": {
								"semanticObject": "comsalsalhrcreateuser",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sal.salhr.createuser",
									"url": sap.ui.require.toUrl("com/sal/salhr/createuser")
								}
							}
						}
					}
