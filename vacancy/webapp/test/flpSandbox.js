		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Vacancy",
									"targetURL": "#comsalvacancy-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsalvacancy-display": {
								"semanticObject": "comsalvacancy",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sal.vacancy",
									"url": sap.ui.require.toUrl("com/sal/vacancy")
								}
							}
						}
					}
