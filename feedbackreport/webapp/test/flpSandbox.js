		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsalfeedbackreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsalfeedbackreport-display": {
								"semanticObject": "comsalfeedbackreport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sal.feedbackreport",
									"url": sap.ui.require.toUrl("com/sal/feedbackreport")
								}
							}
						}
					}
