...
jQuery.sap.declare('sap.se.mi.plm.lib.attachmentservice.library-all');
if ( !jQuery.sap.isDeclared('sap.se.mi.plm.lib.attachmentservice.attachment.Component') ) {
/*
 * Copyright (C) 2009-2020 SAP SE or an SAP affiliate company. All rights reserved.
 */
jQuery.sap.declare('sap.se.mi.plm.lib.attachmentservice.attachment.Component'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('sap.ui.core.UIComponent'); // unlisted dependency retained
sap.ui.define("sap/se/mi/plm/lib/attachmentservice/attachment/Component",["sap/ui/core/UIComponent"],
...
}; // end of sap/se/mi/plm/lib/attachmentservice/attachment/Component.js
if ( !jQuery.sap.isDeclared('sap.se.mi.plm.lib.attachmentservice.attachment.components.stcomponent.Component') ) {
/*
 * Copyright (C) 2009-2020 SAP SE or an SAP affiliate company. All rights reserved.
 */
jQuery.sap.declare('sap.se.mi.plm.lib.attachmentservice.attachment.components.stcomponent.Component'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('sap.ui.core.UIComponent'); // unlisted dependency retained
jQuery.sap.require('sap.suite.ui.generic.template.extensionAPI.ReuseComponentSupport'); // unlisted dependency retained
sap.ui.define("sap/se/mi/plm/lib/attachmentservice/attachment/components/stcomponent/Component",["sap/ui/core/UIComponent", "sap/suite/ui/generic/template/extensionAPI/ReuseComponentSupport"],
...
}; // end of sap/se/mi/plm/lib/attachmentservice/attachment/components/stcomponent/Component.js
if ( !jQuery.sap.isDeclared('sap.se.mi.plm.lib.attachmentservice.attachment.view.Attachment.controller') ) {
/*
 * Copyright (C) 2009-2020 SAP SE or an SAP affiliate company. All rights reserved.
 */
jQuery.sap.declare('sap.se.mi.plm.lib.attachmentservice.attachment.view.Attachment.controller'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
...
sap.ui.define("sap/se/mi/plm/lib/attachmentservice/attachment/view/Attachment.controller",["sap/m/MessageBox", "sap/ui/core/format/DateFormat", "sap/ui/core/format/FileSizeFormat"],
	function (MessageBox) {
		"use strict";
...
}; // end of sap/se/mi/plm/lib/attachmentservice/attachment/view/Attachment.controller.js
if ( !jQuery.sap.isDeclared('sap.se.mi.plm.lib.attachmentservice.library') ) {
/*
 * Copyright (C) 2009-2020 SAP SE or an SAP affiliate company. All rights reserved.
 */
/**
 ...
 */
jQuery.sap.declare('sap.se.mi.plm.lib.attachmentservice.library'); // unresolved dependency added by SAPUI5 'AllInOne' Builder
jQuery.sap.require('sap.m.library'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.Core'); // unlisted dependency retained
jQuery.sap.require('sap.ui.core.library'); // unlisted dependency retained
sap.ui.define("sap/se/mi/plm/lib/attachmentservice/library",["sap/m/library","sap/ui/core/Core","sap/ui/core/library"],
...
}; // end of sap/se/mi/plm/lib/attachmentservice/library.js
