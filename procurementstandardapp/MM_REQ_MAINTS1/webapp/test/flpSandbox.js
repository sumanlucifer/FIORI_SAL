		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Procurement",
									"targetURL": "#ui-s2p-mm-requisition-maintain-s1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui-s2p-mm-requisition-maintain-s1-display": {
								"semanticObject": "uis2pmmrequisitionmaintains1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui.s2p.mm.requisition.maintain.s1",
									"url": sap.ui.require.toUrl("ui/s2p/mm/requisition/maintain/s1")
								}
							}
						}
					}
