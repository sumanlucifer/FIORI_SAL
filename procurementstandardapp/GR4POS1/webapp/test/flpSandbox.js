		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Goods Receipt for Purchase Order",
									"targetURL": "#s2pmmimgoodsreceiptpurchaseorder-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"s2pmmimgoodsreceiptpurchaseorder-display": {
								"semanticObject": "s2pmmimgoodsreceiptpurchaseorder",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=s2p.mm.im.goodsreceipt.purchaseorder",
									"url": sap.ui.require.toUrl("s2p/mm/im/goodsreceipt/purchaseorder")
								}
							}
						}
					}
