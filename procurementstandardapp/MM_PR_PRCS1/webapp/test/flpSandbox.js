		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Procurement",
									"targetURL": "#uissuites2pmmpurprprcsss1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uissuites2pmmpurprprcsss1-display": {
								"semanticObject": "uissuites2pmmpurprprcsss1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui.ssuite.s2p.mm.pur.pr.prcss.s1",
									"url": sap.ui.require.toUrl("ui/ssuite/s2p/mm/pur/pr/prcss/s1")
								}
							}
						}
					}
