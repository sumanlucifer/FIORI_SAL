		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsalhrrequestsummarymanager-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsalhrrequestsummarymanager-display": {
								"semanticObject": "comsalhrrequestsummarymanager",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sal.hrrequestsummarymanager",
									"url": sap.ui.require.toUrl("com/sal/hrrequestsummarymanager")
								}
							}
						}
					}
