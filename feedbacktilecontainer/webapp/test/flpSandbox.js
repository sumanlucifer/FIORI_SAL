		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsalfeedbacktilecontainer-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsalfeedbacktilecontainer-display": {
								"semanticObject": "comsalfeedbacktilecontainer",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sal.feedbacktilecontainer",
									"url": sap.ui.require.toUrl("com/sal/feedbacktilecontainer")
								}
							}
						}
					}
