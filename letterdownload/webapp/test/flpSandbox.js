		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Introduction Letter Download",
									"targetURL": "#comsalletterdownload-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsalletterdownload-display": {
								"semanticObject": "comsalletterdownload",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sal.letterdownload",
									"url": sap.ui.require.toUrl("com/sal/letterdownload")
								}
							}
						}
					}
